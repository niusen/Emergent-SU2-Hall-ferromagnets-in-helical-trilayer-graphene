...
filenm="FBZ_paircorrel_theta1.44_waa"+num2str(waa,'%.1f')+"_epsilon4_Np12_sec";
...
colormap(gca,mycmap);
cb=colorbar;
%save("Sq_36_12"+"_waa"+num2str(waa)+".mat","corners","Sq_values","Sq_points","g1","g3");
...
colormap(gca,mycmap);
cb=colorbar;
save("gr_36_12"+"_waa"+num2str(waa)+".mat","gr_values","gr_points","ax","ay","coord0","Dx","Dy");
